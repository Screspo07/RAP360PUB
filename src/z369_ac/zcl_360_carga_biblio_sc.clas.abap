class zcl_360_carga_biblio_sc definition
  public
  final
  create public .
...
class zcl_360_carga_biblio_sc  implementation.
  ...
  method if_oo_adt_classrun~main.
    ...
    data: lt_acc_categ type table of ztb_acc_categ_sc,
          lt_catego    type table of ztb_categ_sc,
          lt_clientes  type table of ztb_clientes_sc,
          lt_clnts_lib type table of ztb_clien_lib_sc,
          lt_libros    type table of ztb_libros_sc.

******** ztb_acc_categ_l ********
    "fill internal table
    lt_acc_categ = value #(
    ( bi_categ = 'A' type_access = '1' )
    ( bi_categ = 'B' type_access = '1' )
    ( bi_categ = 'C' type_access = '2' )
    ( bi_categ = 'D' type_access = '2' )
    ( bi_categ = 'E' type_access = '2' )
    ( bi_categ = 'F' type_access = '3' )
    ( bi_categ = 'G' type_access = '3' )
    ( bi_categ = 'H' type_access = '4' ) ).

    "Delete possible entries; insert new entries
    delete from ztb_acc_categ_sc.
    insert ztb_acc_categ_sc from table @lt_acc_categ.
...
******** ztb_categ_lgl ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_categ_sc.
    insert ztb_categ_sc from table @lt_catego.
...
******** ztb_clientes_lgl ********
    "fill internal table
    lt_clientes = value #(
    ( id_cliente = '005638984K' type_access = '1' nombre = 'Andrew' apellidos = 'Roberts' email = 'STEPHANIE.ROBERTS@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_cliente = '049320909Q' type_access = '2' nombre = 'Natalie' apellidos = 'Clark' email = 'PETER.CLARK@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '049573865T' type_access = '1' nombre = 'Faith' apellidos = 'Black' email = 'DAN.BLACK@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_cliente = '203947278B' type_access = '3' nombre = 'Carolyn' apellidos = 'Wright' email = 'ADRIAN.WRIGHT@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '234234231T' type_access = '5' nombre = 'Penelope' apellidos = 'King' email = 'CAROLINE.KING@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '239482309W' type_access = '5' nombre = 'Julian' apellidos = 'Underwood' email = 'DAN.UNDERWOOD@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_cliente = '276594867J' type_access = '5' nombre = 'Olivia' apellidos = 'Allan' email = 'OWEN.ALLAN@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '283748858A' type_access = '5' nombre = 'Eric' apellidos = 'Knox' email = 'LILY.KNOX@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_cliente = '324726345S' type_access = '4' nombre = 'Vanessa' apellidos = 'Baker' email = 'SUE.BAKER@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '340958439D' type_access = '5' nombre = 'Michael' apellidos = 'Short' email = 'JASON.SHORT@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '345093450E' type_access = '3' nombre = 'Sue' apellidos = 'Sanderson' email = 'JOAN.SANDERSON@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '345838534R' type_access = '5' nombre = 'Lily' apellidos = 'Langdon' email = 'ANDREW.LANGDON@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '348947597P' type_access = '5' nombre = 'Lillian' apellidos = 'Davies' email = 'JULIAN.DAVIES@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '378458844M' type_access = '5' nombre = 'Joseph' apellidos = 'Smith' email = 'NATALIE.SMITH@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_cliente = '423586845G' type_access = '5' nombre = 'Stephanie' apellidos = 'Quinn' email = 'LILLIAN.QUINN@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '430958433A' type_access = '2' nombre = 'Joan' apellidos = 'Short' email = 'WENDY.SHORT@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_cliente = '439853453C' type_access = '5' nombre = 'Wendy' apellidos = 'Newman' email = 'JOSEPH.NEWMAN@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '453532543O' type_access = '1' nombre = 'Neil' apellidos = 'Wilson' email = 'VANESSA.WILSON@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '489632882D' type_access = '5' nombre = 'Sonia' apellidos = 'Welch' email = 'NEIL.WELCH@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_cliente = '540867547H' type_access = '5' nombre = 'Adrian' apellidos = 'Young' email = 'PENELOPE.YOUNG@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' ) ).

    "Delete possible entries; insert new entries
    delete from ztb_clientes_sc.
    insert ztb_clientes_sc from table @lt_clientes.
...
******** ztb_clnts_lib_l
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clien_lib_sc.
    insert ztb_clien_lib_sc from table @lt_clnts_lib.
...
******** ztb_libros_lgl ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_sc.
    insert ztb_libros_sc from table @lt_libros.
